...
class AssignmentEditorDetail extends ErrorHandlingMixin(SaveStatusMixin(EntityMixinLit(LocalizeActivityAssignmentsMixin(RtlMixin(ActivityEditorMixin(MobxLitElement)))))) {
