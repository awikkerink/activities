...
export default {
	...
	"btnAssignmentCategoryCreate": "Creu", // Categories create button
	"btnAssignmentCategoryCancel": "Canslo", // Categories cancel button
	"inputCategoryLabel": "Enw", // Label for new category input
	"categorySummaryPrefix": "Categori", // Label for new category input
