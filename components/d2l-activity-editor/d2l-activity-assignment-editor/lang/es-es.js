...
export default {
	...
	"allowableFiletypes": "Extensiones de archivo permitidas", // Label for the allowable filetypes field when creating/editing an assignment
	"allowableFileTypesHelp": "Abrir la información de extensiones de archivo permitidas en una nueva pestaña", // Help icon for allowable filetypes info
	"customFiletypes": "Tipos de archivo personalizados", // ARIA label for custom filetypes field
	"customFiletypesNotification": "Introduzca una o más extensiones de archivo permitidas separadas por una coma.", // text for adding custom filetypes
	"customFiletypesPlaceholder": "ejemplo: .pdf, .txt, .html", // Placeholder for the custom filetypes field
	"customFiletypesError": "Introduzca extensiones de archivo válidas", // Error message to inform user that their extension type is invalid
	...
	"assignmentSaveError": "Su tarea no se ha guardado. Corrija los campos señalados.", // Error message to inform the user that there was a problem saving the assignment, instructing them to correct invalid fields
