...
export default {
	...
	"btnAssignmentCategoryCreate": "Maken", // Categories create button
	"btnAssignmentCategoryCancel": "Annuleren", // Categories cancel button
	"inputCategoryLabel": "Naam", // Label for new category input
	"categorySummaryPrefix": "Categorie", // Label for new category input
