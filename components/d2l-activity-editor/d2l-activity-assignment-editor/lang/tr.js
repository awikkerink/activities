...
export default {
	...
	"btnAssignmentCategoryCreate": "Oluştur", // Categories create button
	"btnAssignmentCategoryCancel": "İptal", // Categories cancel button
	"inputCategoryLabel": "Ad", // Label for new category input
