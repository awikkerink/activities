...
export default {
	"addGoogleDriveLink": "إرفاق من Google Drive", // Tooltip for a button that adds a link to a Google Drive file
	"addFile": "تحميل ملف", // Tooltip for a button that opens a file upload dialog
