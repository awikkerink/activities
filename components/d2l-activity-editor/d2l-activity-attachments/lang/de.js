...
export default {
	"addGoogleDriveLink": "Anlage aus Google Drive hinzufügen", // Tooltip for a button that adds a link to a Google Drive file
	"addFile": "Datei-Upload", // Tooltip for a button that opens a file upload dialog
	"addLink": "Weblink hinzufügen", // Tooltip for a button that adds a link to a URL
