...
export default {
	"addGoogleDriveLink": "Joindre à partir de Google Drive", // Tooltip for a button that adds a link to a Google Drive file
	"addFile": "Téléversement de fichier", // Tooltip for a button that opens a file upload dialog
