...
export default {
	"addGoogleDriveLink": "Toevoegen vanuit Google Drive", // Tooltip for a button that adds a link to a Google Drive file
	"addFile": "Bestand uploaden", // Tooltip for a button that opens a file upload dialog
	"addLink": "Koppeling toevoegen", // Tooltip for a button that adds a link to a URL
