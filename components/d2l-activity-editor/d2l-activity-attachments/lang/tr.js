...
export default {
	"addGoogleDriveLink": "Google Drive\'dan Ekle", // Tooltip for a button that adds a link to a Google Drive file
	"addFile": "Dosya Yükleme", // Tooltip for a button that opens a file upload dialog
	"addLink": "Web Bağlantısı Ekle", // Tooltip for a button that adds a link to a URL
