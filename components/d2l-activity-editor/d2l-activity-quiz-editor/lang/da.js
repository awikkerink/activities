...
export default {
	...
	"quizSaveError": "Din eksamination blev ikke gemt. Ret de markerede felter.", // Error message to inform the user that there was a problem saving the quiz, instructing them to correct invalid fields
	"hdrAvailability": "Tilgængelighedsdatoer og betingelser", // availability header
	"hdrTimingAndDisplay": "Timing og visning", // timing/display accordion header
	"subHdrTimingTools": "Tidsindstilling", // Title for timing tools
	...
	"hintsToolDescription": "Tillad tip", // decription for hints tool
	"hintsAllowedSummary": "Tip tilladt", // summary text when hints are enabled,
	"passwordLabel": "Adgangskode", // Label for the quiz password text input field
	"passwordSummary": "Beskyttet med adgangskode", // summary text when quiz has a password
	"disableRightClickDescription": "Deaktivér højreklik", // description for disable right click
	"disableRightClickSummary": "Højreklik deaktiveret", // summary text when right clicks are disabled
	"preventMovingBackwardsDescription": "Undgå at vende tilbage til foregående sider",
	"disablePagerAndAlertsDescription": "Deaktivér e-mail, chatbeskeder og beskeder i Brightspace", // description for blocking communications / disable pager and alerts during a quiz
	"disablePagerAndAlertsSummary": "Beskeder og kommunikation er blokerede", // summary text when communications / pager and alerts are disabled
	"emailNotificationSummary": "Meddelelse om forsøg via e-mail", // summary for email notification
	"preventMovingBackwardsSummary": "Begrænsninger for personsøgning", // summary for prevent moving backwards checkbox
	"dividerHeader": "Spørgsmål", // The header that is displayed on the divider
	"previewLabel": "Forhåndsvisning", // The label text for the preview button
	...
	"disableAlertsAccessibleHelpText": "Få hjælp til – Deaktivér e-mail, chatbeskeder og beskeder i Brightspace", // accessible help text for disable alerts question mark button
	...
	"description": "Beskrivelse", // Description label for the Description text input box,
	"btnOpenIpRestrictionDialog": "Administrer IP-begrænsninger", // Button text for opening IP restriction dialog
	"hdrIpRestrictionDialog": "IP-begrænsninger (IPv4)", // timing/display accordion header
	"ipRestrictionLabel": "IP-begrænsninger", // Label for IP restrictions editor
	"minutesLabel": "minut(ter)",  // label for Timing dialog time limit input slot
	"minutesBeforeFlaggedLabel": "minut(ter), før den markeres som overskredet tidsgrænse", // label for Timing dialog grace period input slot
	"extendedDeadlineLabel": "Forlænget frist",  // label for timing dialog - extended deadline select
	"extendedDeadlineInputLabel": "minut(ter) efter fristen er udløbet",  //label for Timing dialog extended deadline select slot
	"subHdrExceededTimeLimitBehaviour": "Adfærd ved overskredet tidsgrænse", // Title for submission late type options,
	"exceededTimeLimitBehaviourPrefix": "Markér eksaminationsforsøget, når fristen er overskredet, og", // label for submission label type options
	"showClockLabel": "Vises, inden eksaminationen starter", // Label for show clock checkbox
	"showClockTitle": "Vis ur", // Title for show clock
	"manageAttemptsDialogConfirmationText": "OK", // copy that appears on the Attempts dialog confirmation button
	"manageAttemptsDialogCancelText": "Annuller", // copy that appears on the Attempts dialog cancel button
	"subHdrAttemptsTools": "Forsøg", // Title for attempts tools
	"manageAttempts": "Administrer forsøg", // Label for button to launch attempts dialog
	"textIsDisplayedPart1": "Felter kan ikke slås fra i den nye oplevelse for oprettelse af eksaminationer.", // First sentence of alert warning that text fields will be visible
	"textIsDisplayedSingularPart2": "{field} Feltet vises for elever, når eksaminationen gemmes.", // Second sentence of alert warning that text fields will be visible, when there is only one field
	"introMovedToDescription": "Eksaminationer understøtter ikke længere introduktioner. Eksisterende indhold i feltet for introduktion vises nu i feltet Beskrivelse.", // Alert warning that existing quiz introduction has been removed and that the text in the introduction has been put into the quiz description
	"attemptsAllowed": "Forsøg tilladt", // Title for Attempts Allowed select in Attempts dialog
	"quizAttemptsAllowedSummary": "{numAttemptsAllowed, plural, =1 {1 forsøg tilladt} other {{numAttemptsAllowed} forsøg tilladt}}", //
	"overallGradeCalculation": "Udregning af samlet karakter", // Title for Overall Grade Calculation select in Attempts dialog
	"retakeIncorrectQuestionsOnly": "Besvar kun spørgsmål med forkerte svar igen", // Title for RIO checkbox in Attempts dialog
	"rioCheckboxLabel": "Ved nye forsøg må du kun tillade svar på spørgsmål, der tidligere var besvaret forkert", // Label for RIO checkbox in Attempts dialog
	...
	"btnIpRestrictionsDialogBtnCancel": "Annuller", // text for IP restrictions dialog "Cancel" button
	"ipRestrictionsDialogAddNewRange": "IP-interval", // text for IP restrictions dialog "Add new IP range" button
	...
	"hdrIpRestrictionsHelpDialog": "Information: IP-begrænsninger (IPv4)", // timing/display accordion header
	"hdrIpRestrictionsHelpDialogP1": "Hvis du vil angive et område for accepterede IP-adresser, skal du indtaste fire sæt værdier fra 0 til 255 adskilt af et punktum henholdsvis i felterne IP-startinterval (IP Range Start)- og IP-slutinterval (IP Range End).", // IP restrictions help dialog paragraph 1
	...
	"attemptConditionsParagraph2": "Hvis et minimums- eller maksimumsfelt er tomt, vil der ikke blive anvendt en grænse for den del af forsøgsområdet.", // content for paragragh2 on the Attempts dialog Attempts Condition section
	"attemptConditionsRangePrefixText1": "Ved forsøg {index}:", // prefix text 1 for Attempt Conditions range editor on Attempts dialog
	"attemptConditionsRangePrefixText2": "Deltagere skal opnå mellem", // prefix text 2 for Attempt Conditions range editor on Attempts dialog
	"attemptConditionsRangeSuffixText1": "for at frigive", //suffix text 1 for Attempts Conditions range editor on Attempts dialog
	"attemptConditionsRangeSuffixText2": "Forsøg {next}", // suffix text 2 for Attempts Condition range editor on Attempts dialog
	"minLabel": "Min.:", // label for Min input on Attempts Conditions range editor on Attempts Dialog
	"maxLabel": "Maks.:", // label for Max input on Attempts Conditions range editor on Attempts Dialog
	"andRangeText": "og", // copy on Attempts Condition range editor on Attempts Dialog
	"percentageRangeText": "%", // copy on Attempts Condition range editor on Attempts Dialog
	"ipRestrictionsSummary": "IP-begrænsninger", // summary to be displayed when a quiz has ip restrictions
	"ipRestrictionsInnerSummary" : "{count, plural, =1 {1 begrænsning} other {{count} begrænsninger}}", // summary to be displayed when accordion is expanded
	"quizTimingValidationError": "Timing kan ikke ændres. Ret de markerede felter.", // Appears in error alert when validation fails in Manage Timing dialog
	"quizTimingServerError": "Noget gik galt. Prøv igen.", // Timing save server error alert message
	"quizTimingRecommendedSummary": "Anbefalet tidsgrænse ({numMinutes, plural, =1 {1 minut} other {{numMinutes} minutter}})", // Recommended time limit (x minute) or (x minutes).
	"quizTimingEnforcedSummary": "Gennemtvunget tidsgrænse ({numMinutes, plural, =1 {1 minut} other {{numMinutes} minutter}})", // Enforced time limit(x minute) or (x minutes).
	"ipRestrictionsDuplicateError": "Startadressen for IP-intervallet findes allerede. Hver startværdi for IP-intervallet skal være entydig.", // Error for duplicate IP
	"ipRestrictionsRangeError": "Ugyldigt IP-adresseinterval angivet. Kontrollér, at intervallerne er formateret korrekt.", // Error for invalid IP ranges
	"quizAttemptsValidationError": "Forsøg kan ikke ændres. Ret de markerede felter.", // Appears in error alert when validation fails in Manage Attempts dialog
	"totalPoints": "Samlet antal point {scoreOutOf}", // Total points text that appears on quiz editor above list of questions
	"subHdrHeaderFooter": "Sidehoved og sidefod", // Header and Footer accordion header
	"manageHeaderFooterButton": "Administrer sidehoved og sidefod", // Label for button to launch Header and Footer dialog
	"headerFooterDialogTitle": "Sidehoved og sidefod",
	"manageHeaderFooterDialogAddText": "Tilføj", // Label for Add button for header and footer dialog
	"manageHeaderFooterDialogCancelText": "Annuller", // Label for Cancel button header and footer dialog
	"headerLabel": "Sidehoved", // Label for the header text box
	"headerDialogText": "Eksaminationens sidehoved og sidefod er synlige for eleverne i henholdsvis toppen og bunden af eksaminationen.", // Header and Footer dialog text
	"header": "Sidehoved", // Header label for the header text box.
	"headerAdded": "Sidehoved tilføjet", // Header added summary text for Timing and Display accordion.
	"footerAdded": "Sidefod tilføjet", // Footer added summary text for Timing and Display accordion.
	"headerAndFooterAdded": "Sidehoved og sidefod tilføjet", // Header and footer added text for Timing and Display accordion.
	"footer": "Sidefod", // Footer lable for the footer text box.
	"footerLabel": "Sidefod", // Label for the footer text box.
