...
export default {
	...
	"quizSaveError": "Ditt förhör sparades inte. Korrigera de markerade fälten.", // Error message to inform the user that there was a problem saving the quiz, instructing them to correct invalid fields
	"hdrAvailability": "Tillgängliga datum och villkor", // availability header
	"hdrTimingAndDisplay": "Tidmätning och visning", // timing/display accordion header
	"subHdrTimingTools": "Tidmätning", // Title for timing tools
	...
	"hintsToolDescription": "Tillåt tips", // decription for hints tool
	"hintsAllowedSummary": "Tips är tillåtna", // summary text when hints are enabled,
	"passwordLabel": "Lösenord", // Label for the quiz password text input field
	"passwordSummary": "Lösenordsskyddad", // summary text when quiz has a password
	"disableRightClickDescription": "Avaktivera högerklickning", // description for disable right click
	"disableRightClickSummary": "Högerklickning avaktiverat", // summary text when right clicks are disabled
	"preventMovingBackwardsDescription": "Förhindra att gå tillbaka till föregående sidor",
	"disablePagerAndAlertsDescription": "Avaktivera e-post, snabbmeddelanden och aviseringar i Brightspace", // description for blocking communications / disable pager and alerts during a quiz
	"disablePagerAndAlertsSummary": "Varningar och kommunikation har blockerats", // summary text when communications / pager and alerts are disabled
	"emailNotificationSummary": "Avisering av försök via e-post", // summary for email notification
	"preventMovingBackwardsSummary": "Sidbegränsningar", // summary for prevent moving backwards checkbox
	"dividerHeader": "Frågor", // The header that is displayed on the divider
	"previewLabel": "Förhandsgranska", // The label text for the preview button
	...
	"disableAlertsAccessibleHelpText": "Få hjälp med – Avaktivera e-post, snabbmeddelanden och aviseringar i Brightspace", // accessible help text for disable alerts question mark button
	...
	"description": "Beskrivning", // Description label for the Description text input box,
	"btnOpenIpRestrictionDialog": "Hantera IP-begränsningar", // Button text for opening IP restriction dialog
	"hdrIpRestrictionDialog": "IP-begränsningar (IPv4)", // timing/display accordion header
	"ipRestrictionLabel": "IP-begränsningar", // Label for IP restrictions editor
	"minutesLabel": "minuter",  // label for Timing dialog time limit input slot
	"minutesBeforeFlaggedLabel": "minut(er) före flaggning för överskriden tidsgräns", // label for Timing dialog grace period input slot
	"extendedDeadlineLabel": "Förlängd tidsgräns",  // label for timing dialog - extended deadline select
	"extendedDeadlineInputLabel": "minut(er) efter det att respittiden avslutas",  //label for Timing dialog extended deadline select slot
	"subHdrExceededTimeLimitBehaviour": "Om tidsgränsen överskrids", // Title for submission late type options,
	"exceededTimeLimitBehaviourPrefix": "Efter respitperioden, flagga att tidsgränsen för förhörsförsöket har överskridits och", // label for submission label type options
	"showClockLabel": "Visas innan testet börjar", // Label for show clock checkbox
	"showClockTitle": "Visa klocka", // Title for show clock
	"manageAttemptsDialogConfirmationText": "OK", // copy that appears on the Attempts dialog confirmation button
	"manageAttemptsDialogCancelText": "Avbryt", // copy that appears on the Attempts dialog cancel button
	"subHdrAttemptsTools": "Försök", // Title for attempts tools
	"manageAttempts": "Hantera försök", // Label for button to launch attempts dialog
	"textIsDisplayedPart1": "Det går inte att stänga fält i den nya funktionen för att skapa förhör.", // First sentence of alert warning that text fields will be visible
	"textIsDisplayedSingularPart2": "Fältet {field} visas för eleverna när förhöret har sparats.", // Second sentence of alert warning that text fields will be visible, when there is only one field
	"introMovedToDescription": "Förhör har inte längre stöd för Introduktioner. Befintligt innehåll i fältet Introduktion visas nu i fältet Beskrivning.", // Alert warning that existing quiz introduction has been removed and that the text in the introduction has been put into the quiz description
	"attemptsAllowed": "Tillåtna försök", // Title for Attempts Allowed select in Attempts dialog
	"quizAttemptsAllowedSummary": "{numAttemptsAllowed, plural, =1 {1 försök tillåtet} other {{numAttemptsAllowed} försök tillåtna}}", //
	"overallGradeCalculation": "Beräkning av totalbetyg", // Title for Overall Grade Calculation select in Attempts dialog
	"retakeIncorrectQuestionsOnly": "Besvara endast felaktiga frågor på nytt", // Title for RIO checkbox in Attempts dialog
	"rioCheckboxLabel": "Tillåt endast svar på felaktiga frågor vid nya försök", // Label for RIO checkbox in Attempts dialog
	...
	"btnIpRestrictionsDialogBtnCancel": "Avbryt", // text for IP restrictions dialog "Cancel" button
	"ipRestrictionsDialogAddNewRange": "IP-intervall", // text for IP restrictions dialog "Add new IP range" button
	...
	"hdrIpRestrictionsHelpDialog": "Information: IP-begränsningar (IPv4)", // timing/display accordion header
	"hdrIpRestrictionsHelpDialogP1": "Ange fyra värdesuppsättningar från 0 till 255, (åtskilda av en punkt) i fälten Start på IP-intervall respektive Slut på IP-intervall för att ange ett intervall för godkända IP-adresser.", // IP restrictions help dialog paragraph 1
	...
	"attemptConditionsParagraph2": "Om ett minsta eller största fält är tomt sätts ingen gräns för den försöksintervallsdelen.", // content for paragragh2 on the Attempts dialog Attempts Condition section
	"attemptConditionsRangePrefixText1": "Vid försök {index}:", // prefix text 1 for Attempt Conditions range editor on Attempts dialog
	"attemptConditionsRangePrefixText2": "eleven måste uppnå mellan", // prefix text 2 for Attempt Conditions range editor on Attempts dialog
	"attemptConditionsRangeSuffixText1": "för att publicera", //suffix text 1 for Attempts Conditions range editor on Attempts dialog
	"attemptConditionsRangeSuffixText2": "Försök {next}", // suffix text 2 for Attempts Condition range editor on Attempts dialog
	...
	"andRangeText": "och", // copy on Attempts Condition range editor on Attempts Dialog
	"percentageRangeText": "%", // copy on Attempts Condition range editor on Attempts Dialog
	"ipRestrictionsSummary": "IP-begränsningar", // summary to be displayed when a quiz has ip restrictions
	"ipRestrictionsInnerSummary" : "{count, plural, =1 {1 begränsning} other {{count} begränsningar}}", // summary to be displayed when accordion is expanded
	...
	"totalPoints": "Totalt antal poäng {scoreOutOf}", // Total points text that appears on quiz editor above list of questions
	"subHdrHeaderFooter": "Sidhuvud och sidfot", // Header and Footer accordion header
	"manageHeaderFooterButton": "Hantera sidhuvud och sidfot", // Label for button to launch Header and Footer dialog
	"headerFooterDialogTitle": "Sidhuvud och sidfot",
	"manageHeaderFooterDialogAddText": "Lägg till", // Label for Add button for header and footer dialog
	"manageHeaderFooterDialogCancelText": "Avbryt", // Label for Cancel button header and footer dialog
	"headerLabel": "Rubrik", // Label for the header text box
	"headerDialogText": "Förhörets sidhuvud och sidfot är synliga för eleverna högst upp respektive längst ned i förhöret.", // Header and Footer dialog text
	"header": "Rubrik", // Header label for the header text box.
	"headerAdded": "Rubrik har lagts till", // Header added summary text for Timing and Display accordion.
	"footerAdded": "Sidfot har lagts till", // Footer added summary text for Timing and Display accordion.
	"headerAndFooterAdded": "Sidhuvud och sidfot har lagts till", // Header and footer added text for Timing and Display accordion.
	"footer": "Sidfot", // Footer lable for the footer text box.
	"footerLabel": "Sidfot", // Label for the footer text box.
