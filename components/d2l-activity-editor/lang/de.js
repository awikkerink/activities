...
export default {
	...
	"endDate": "Enddatum", // ARIA label for the due date field when creating/editing an activity
	...
	"endTime": "Endzeit", // ARIA label for the due time field when creating/editing an activity
	"startTime": "Startzeit", // ARIA label for the due time field when creating/editing an activity
