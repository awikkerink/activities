...
export default {
	...
	"txtNumSpecialAccess": "{userCount, plural, =1 {{userCount} user with special access} other {{userCount} users with special access}}", // num users with special access text
