...
export default {
	...
	"ariaHidden": "Masqué pour les élèves", // Aria Label for the visibility switch when hidden
	...
	"ariaVisible": "Visible pour les étudiants", // Aria Label for the visibility switch when visible
