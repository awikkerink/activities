...
export default {
	...
	"endDate": "종료일", // ARIA label for the due date field when creating/editing an activity
	"startDate": "시작일", // ARIA label for the due date field when creating/editing an activity
	"dueTime": "기한 시간", // ARIA label for the due time field when creating/editing an activity
	"endTime": "종료 시각", // ARIA label for the due time field when creating/editing an activity
	"startTime": "시작 시각", // ARIA label for the due time field when creating/editing an activity
