...
export default {
	...
	"endTime": "Sluttid", // ARIA label for the due time field when creating/editing an activity
	"startTime": "Starttid", // ARIA label for the due time field when creating/editing an activity
