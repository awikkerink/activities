...
class D2LQuickEvalWidgetNoSubmissionImage extends LitElement {
	render() {
		return html`
			<style>
				:host {
      ...
      <svg
        ...
        viewBox="0 0 294 152.1">
        <defs>
          <style>
            .st0{fill:#F8FAFD;}
            .st1{clip-path:url(#SVGID_2_);}
            .st2{opacity:0.2088;clip-path:url(#SVGID_4_);fill:#494C4E;enable-background:new    ;}
...
customElements.define('d2l-quick-eval-widget-no-submissions-image', D2LQuickEvalWidgetNoSubmissionImage);
