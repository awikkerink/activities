...
export default {
   ...
   "publishAllToastMessage" : "{activityName} の評価が正常に公開されました。",
   "publishAllToastMessageTruncated" : "{truncatedActivityName}… の評価が正常に公開されました。",
   "published" : "公開済み",
   "quiz" : "クイズ",
   "restore" : "復元",
   "search" : "検索",
   ...
   "toggleIndicatorLabelActions" : "{target} にアクションを実行",
