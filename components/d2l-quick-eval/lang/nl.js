...
export default {
   ...
   "activityRestored" : "{count, plural, =1 {1 activiteit is} other {{count} activiteiten zijn}} hersteld",
   "assignment" : "Opdracht",
   "cancel" : "Annuleren",
   "caughtUp" : "U bent weer helemaal bij!",
   "checkBackOften" : "Kijk regelmatig of er nieuwe indieningen zijn.",
   "checkBackOftenCourseLevel": "Controleer {startTag}Snelle evaluatie van meerdere cursussen{endTag} om te zien of er nieuwe indieningen zijn in uw andere cursussen.",
   ...
   "failedToDismissActivity" : "Activiteit kan niet worden genegeerd. Probeer het later opnieuw.",
   ...
   "multiCourseQuickEval": "Snelle evaluatie van meerdere cursussen",
   ...
   "newSubmissions" : "Nieuwe indieningen",
   "nextSubmission" : "Volgende indiening",
   "no" : "Nee",
   ...
   "noDismissedActivities" : "U hebt momenteel geen genegeerde activiteiten. U kunt hier genegeerde activiteiten bekijken en herstellen.",
   "noResults" : "Geen resultaten hier.",
   "noSubmissions" : "Er zijn geen indieningen die uw aandacht nodig hebben.",
   "noSubmissionsCourseLevel": "Er zijn in deze cursus geen indieningen die uw aandacht vereisen.",
   "optionsForQuickEval" : "Opties voor snelle evaluatie",
   "publishAll" : "Alles publiceren",
   "publishAllConfirmDialogMessage" : "{evaluated} van de {assigned} gebruikers ontvangt/ontvangen feedback na publicatie. Wilt u doorgaan?",
   ...
   "restore" : "Herstellen",
   "search" : "Zoeken",
   "searchResultsMore" : "Meer dan {num} zoekresultaten",
   ...
   "tableTitle" : "Lijst van niet-geëvalueerde indieningen van cursisten van cursussen en tools",
   "toggleIndicatorLabelActions" : "Acties uitvoeren op {target}",
   "toggleIndicatorLabelInfo" : "Info weergeven over {target}",
