	...
	describe('Annotations Editor', () => {
		it('loads properly and is visible when user can edit annotations', async() => {
			...
			const annotationEditorComponent =
				el.shadowRoot.querySelectorAll('d2l-activity-accordion-collapse > .d2l-editor > d2l-activity-assignment-annotations-editor');
	...
	describe('Anonymous Marking Editor', () => {
		it('loads properly and is visible when anonymous marking is avaliable', async() => {
			...
			const anonMarkingEditorComponent =
				el.shadowRoot.querySelectorAll('d2l-activity-accordion-collapse > .d2l-editor > d2l-activity-assignment-anonymous-marking-editor');
	...
	describe('Turn It In Editor', () => {
		it('loads properly and is visible when anonymous marking is avaliable', async() => {
			...
			const turnItInEditorComponent =
				el.shadowRoot.querySelectorAll('d2l-activity-accordion-collapse > .d2l-editor > d2l-assignment-turnitin-editor');
